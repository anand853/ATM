			...
			<table border="1" borderColor="#ffe9bf" cellPadding="0"
				...
				<tbody>
					...
					<td bgColor="#008080" width="224" height="19"><font
						color="#ffffff"><b>Account Number</b></font></td>
					...
					<%
						...
						try {
							...
							rst = stmt.executeQuery(
									"SELECT T.TRANSACTION_ID,A.ACCOUNT_NUMBER,T.AMOUNT FROM TRANSACTION T , ACCOUNT_DETAILS A");
							while (rst.next()) {
					...
					<tr>
						...
						<td bgColor="#ffcc68" vAlign="top" width="224" height="19"><%=rst.getString(2)%></td>
